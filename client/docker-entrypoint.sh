...
window.__ENV = {
  ...
  NEXT_PUBLIC_BRAND_NAME: "$(sanitize "${NEXT_PUBLIC_BRAND_NAME:-}")",
  NEXT_PUBLIC_BRAND_LOGO: "$(sanitize "${NEXT_PUBLIC_BRAND_LOGO:-}")",
  NEXT_PUBLIC_BRAND_LOGO_DARK: "$(sanitize "${NEXT_PUBLIC_BRAND_LOGO_DARK:-}")",
  NEXT_PUBLIC_BRAND_LOGO_SECONDARY: "$(sanitize "${NEXT_PUBLIC_BRAND_LOGO_SECONDARY:-}")",
  NEXT_PUBLIC_BRAND_LOGO_SECONDARY_DARK: "$(sanitize "${NEXT_PUBLIC_BRAND_LOGO_SECONDARY_DARK:-}")",
};
JSEOF
